# 🧩 The Production Media & Infrastructure Stack (`reference/media-stack/`)
...
If you look at the bottom of [`docker-compose.yml`](docker-compose.yml#L617-L625), you will notice that this production stack does **not** put all containers on a single flat network. Instead, it deploys a **Tri-Network Architecture**:
...
## 📦 What Every Container in This Stack Does

To help you understand the purpose of all 25 containers defined inside [`docker-compose.yml`](docker-compose.yml), here is a complete breakdown organized by functional tier:
